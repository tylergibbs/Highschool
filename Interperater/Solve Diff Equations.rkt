...
;uses racket's macros to define a langedge that can calculate any math equation that
;uses + * ^ ln() ^-1 -1* sin() cos(), take the differential, gradiant, determain equality
